...
/**
 * @internal FooAbstractClient provides abstraction for JsonClient and Client (default).
 ...
 */
abstract class FooAbstractClient
{
    /**
     * @var server
     */
     ...
     * {@inheritdoc}
     */
    public function Bar(array $ctx, \Bar\Bar $in): \Google\Protobuf\GPBEmpty
    {
        ...
        if (empty($this->prefix)) {
            ...
            $url = $url.'/'.$this->prefix.'/foo.Foo/Bar';
        }
